...
- [ ] Добавить проверку на доступность денег
- [ ] Добавить проверку на начало торгов
- [ ] Исключить время для песочницы
- [ ] Проверка на правильность токена
- [ ] Проверка типов данных (цена - число)
...
- [ ] Добавить проверку на доступность денег / продажа
